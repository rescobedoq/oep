...
class Graph;  // Graph NO está en namespace
class PathfindingService;  // PathfindingService NO está en namespace services
class TspService;          // TspService NO está en namespace services

namespace services {
class GraphService;  // GraphService SÍ está en namespace services
}
 ...
 * ├──────────────┬──────────────────────────────┤
 * │              │                              │
 * │ ControlPanel │        MapWidget             │
 * │  (izq 25%)   │        (centro 75%)          │
 * │              │                              │
 * ├──────────────┴──────────────────────────────┤
 * │      ResultsPanel (abajo 25%)               │
 * └─────────────────────────────────────────────┘
 */
...
private:
    ...
    // Últimos resultados
    void* lastPathResult_;  // PathfindingService::PathResult*
    void* lastTspResult_;   // TspService::TspResult*
